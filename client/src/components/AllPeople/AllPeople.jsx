...
export default function AllPeople(){
  ...
  useEffect(() => {
    const getAll = async () =>{
      setPeople(await AuthApi.getAll())
    }
    getAll()
  }, [])
  return(
    <section className="allPeople">
        ...
        </div>
      {
            ...
            people.map(person => {
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <Link to="#" className="btn btn-primary">Page</Link>
                </div>
              </div>
            </div>
            })
        ...
        // <div className="peoples d-flex">
        //   {
        //     people.map((person, index) => {
        //       return <div key={person.id} className="person">
        //         <span className="index">{index + 1}</span>
        //         <span className="icon"><img src="https://cdn.icon-icons.com/icons2/1378/PNG/512/avatardefault_92824.png" alt="icon" /></span>
        //         <span className="username">{person.username}</span>
        //         <Link className="page" to="/">Page</Link>
        //       </div>
        //     })
        //   }
        // </div> 
